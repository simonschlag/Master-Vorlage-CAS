...
\setzekurs{ABC2008DE}
\setzetitel{In der Regel haben wir einen zweizeiligen Masterthesistitel}
\setzedatumAbgabe{\today}
\setzefirma{Firma GmbH}
\setzefirmenort{Firmenort}
\setzeabgabeort{Abgabeort}
\setzeabschluss{Master of Engineering (M. Eng.)}
\setzestudiengang{Integrated Engineering}
\setzedhbw{am Center for Advanced Studies}
\setzebetreuer{Dipl.-Ing.~(FH) Peter Pan}
\setzegutachter{Dr.\ Silvana Koch-Mehrin}
\setzezeitraum{xx.yy.zzzz - xx.yy.zzzz}
